		...
		<div id="demo1" class="carousel slide carousel-fade" data-ride="carousel" data-interval="false">
			...
			<div class="carousel-inner">
				...
				<div class="carousel-item active my-4">
					...
					<div class="img-container my-2 auto">
						<img src="/wp-content/themes/aei/images/deep-binary-scan.webp" alt="deep-binary-scan">
					</div>

					<h6 class="text-white font-weight-bold">DEEP SOFTWARE SCANNING</h6>
					<div class="info">
				...
				<div class="carousel-item my-4">
					<div class="img-container my-2 auto">
						<img src="/wp-content/themes/aei/images/personalized-assessment.webp" alt="personalized-assessment">
					</div>	
					<h6 class="text-white font-weight-bold">PERSONALIZED RISK ASSESSMENTS</h6>
					<div class="info">
				...
				<div class="carousel-item my-4">
					<div class="img-container my-2 auto">
						<img src="/wp-content/themes/aei/images/score-and-steps.webp" alt="score-and-steps">
					</div>
					<h6 class="text-white font-weight-bold">ACTIONABLE CYBER SCORES</h6>
					<div class="info">
				...
				<ul class="nav align-items-end">
					<li data-target="#custom_carousel" data-slide-to="0" class="active">
						<div class="img-container">
							<a href="#">
								<img src="/wp-content/themes/aei/images/slider_1_plain.webp" class="img-fluid img-plain" alt="challenges and solutions" >
								<img src="/wp-content/themes/aei/images/slider_1_colored.webp" class="img-color img-fluid" alt="challenges and solutions">
							</a>
						</div>
					...
					<li data-target="#custom_carousel" data-slide-to="2">
						<div class="img-container">
							<a href="">
								<img src="/wp-content/themes/aei/images/slider_3_plain.webp" class="img-fluid img-plain" alt="challenges and solutions" >
								<img src="/wp-content/themes/aei/images/slider_3_colored.webp" class="img-color img-fluid" alt="challenges and solutions">
							</a>
						</div>
					...
					<li data-target="#custom_carousel" data-slide-to="3">
						<div class="img-container">
							<a href="" class="text-center">
								<img src="/wp-content/themes/aei/images/slider_4_plain.webp" class="img-fluid img-plain" alt="challenges and solutions" >
								<img src="/wp-content/themes/aei/images/slider_4_colored.webp" class="img-color img-fluid" alt="challenges and solutions">
							</a>						
						</div>					
					...
					<li data-target="#custom_carousel" data-slide-to="4">
						<div class="img-container">
							<a href="" class="text-center">
								<img src="/wp-content/themes/aei/images/slider_5_plain.webp" class="img-fluid img-plain" alt="challenges and solutions" >
								<img src="/wp-content/themes/aei/images/slider_5_colored.webp" class="img-color img-fluid" alt="challenges and solutions">
							</a>
						</div>
